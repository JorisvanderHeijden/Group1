...
predict the number of 'runs' each player can score.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{moneyball} \PY{o}{=} \PY{n}{oml}\PY{o}{.}\PY{n}{datasets}\PY{o}{.}\PY{n}{get\PYZus{}dataset}\PY{p}{(}\PY{l+m+mi}{41021}\PY{p}{)}\PY{p}{;} \PY{c+c1}{\PYZsh{} Download MoneyBall data}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:}           Team  League     Year       RA   {\ldots}    RankPlayoffs        G  \textbackslash{}
...
C:\textbackslash{}Users\textbackslash{}s140737\textbackslash{}AppData\textbackslash{}Local\textbackslash{}Continuum\textbackslash{}anaconda3\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}sklearn\textbackslash{}model\_selection\textbackslash{}\_split.py:605: Warning: The least populated class in y has only 7 members, which is too few. The minimum number of members in any class cannot be less than n\_splits=10.
  \% (min\_groups, self.n\_splits)), Warning)
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_17_40.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
C:\textbackslash{}Users\textbackslash{}s140737\textbackslash{}AppData\textbackslash{}Local\textbackslash{}Continuum\textbackslash{}anaconda3\textbackslash{}lib\textbackslash{}site-packages\textbackslash{}sklearn\textbackslash{}model\_selection\textbackslash{}\_split.py:605: Warning: The least populated class in y has only 7 members, which is too few. The minimum number of members in any class cannot be less than n\_splits=10.
  \% (min\_groups, self.n\_splits)), Warning)
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_17_79.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
0.28423612125558273
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_19_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
or cosmic rays.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Get the data}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Quick visualization}
...
your report.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{model\PYZus{}selection} \PY{k}{import} \PY{n}{ShuffleSplit}
...
[   1    1    2    3    4    6    9   13   19   27   38   55   80  115
  165  238  343  494  711 1024]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-11-427640831f2b> in <module>()
         98     return
         99 
    --> 100 Question4()
        101 
        ...
        <ipython-input-11-427640831f2b> in Question4()
         26         for i, (train\_index, test\_index) in enumerate(shuffle\_split.split(X)):
         27             \# Train and predict
    ---> 28             clf =  RandomForestClassifier(n\_estimators=n\_treesA[n]) \#ensemble.GradientBoostingClassifier
         29             clf.fit(X[train\_index], y[train\_index])
         30             y\_pred = clf.predict(X[test\_index])
...
use a default train-test split.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{} Plots validation curves for every classifier in clfs. }
         ...
         \PY{n}{classifiers} \PY{o}{=} \PY{p}{[}
             \PY{n}{GradientBoostingClassifier}\PY{p}{(}\PY{n}{n\PYZus{}estimators}\PY{o}{=}\PY{l+m+mi}{5000}\PY{p}{,}\PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,}\PY{n}{max\PYZus{}depth}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{c+c1}{\PYZsh{}n\PYZus{}estimators=3, }
             \PY{n}{GradientBoostingClassifier}\PY{p}{(}\PY{n}{n\PYZus{}estimators}\PY{o}{=}\PY{l+m+mi}{5000}\PY{p}{,}\PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,}\PY{n}{max\PYZus{}depth}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,}
             \PY{n}{GradientBoostingClassifier}\PY{p}{(}\PY{n}{n\PYZus{}estimators}\PY{o}{=}\PY{l+m+mi}{5000}\PY{p}{,}\PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{max\PYZus{}depth}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{c+c1}{\PYZsh{}n\PYZus{}estimators=3, }
             \PY{n}{GradientBoostingClassifier}\PY{p}{(}\PY{n}{n\PYZus{}estimators}\PY{o}{=}\PY{l+m+mi}{5000}\PY{p}{,}\PY{n}{learning\PYZus{}rate}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{max\PYZus{}depth}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
         ...
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         \PY{l+s+sd}{train\PYZus{}scores, test\PYZus{}scores = validation\PYZus{}curve(}
         \PY{l+s+sd}{    SVC(), X\PYZus{}train, y\PYZus{}train, param\PYZus{}name=\PYZdq{}gamma\PYZdq{}, param\PYZus{}range=param\PYZus{}range,}
         \PY{l+s+sd}{    cv=10, scoring=\PYZdq{}accuracy\PYZdq{}, n\PYZus{}jobs=1)}
         \PY{l+s+sd}{train\PYZus{}scores\PYZus{}mean = np.mean(train\PYZus{}scores, axis=1)}
         \PY{l+s+sd}{train\PYZus{}scores\PYZus{}std = np.std(train\PYZus{}scores, axis=1)}
         \PY{l+s+sd}{test\PYZus{}scores\PYZus{}mean = np.mean(test\PYZus{}scores, axis=1)}
         \PY{l+s+sd}{test\PYZus{}scores\PYZus{}std = np.std(test\PYZus{}scores, axis=1)}
         
         \PY{l+s+sd}{plt.title(\PYZdq{}Validation Curve with SVM\PYZdq{})}
         \PY{l+s+sd}{plt.xlabel(\PYZdq{}\PYZdl{}\PYZbs{}gamma\PYZdl{}\PYZdq{})}
         \PY{l+s+sd}{plt.ylabel(\PYZdq{}Score\PYZdq{})}
         \PY{l+s+sd}{plt.ylim(0.0, 1.1)}
         \PY{l+s+sd}{lw = 2}
         \PY{l+s+sd}{plt.semilogx(param\PYZus{}range, train\PYZus{}scores\PYZus{}mean, label=\PYZdq{}Training score\PYZdq{},}
         \PY{l+s+sd}{             color=\PYZdq{}darkorange\PYZdq{}, lw=lw)}
         \PY{l+s+sd}{plt.fill\PYZus{}between(param\PYZus{}range, train\PYZus{}scores\PYZus{}mean \PYZhy{} train\PYZus{}scores\PYZus{}std,}
         \PY{l+s+sd}{                 train\PYZus{}scores\PYZus{}mean + train\PYZus{}scores\PYZus{}std, alpha=0.2,}
         \PY{l+s+sd}{                 color=\PYZdq{}darkorange\PYZdq{}, lw=lw)}
         \PY{l+s+sd}{plt.semilogx(param\PYZus{}range, test\PYZus{}scores\PYZus{}mean, label=\PYZdq{}Cross\PYZhy{}validation score\PYZdq{},}
         \PY{l+s+sd}{             color=\PYZdq{}navy\PYZdq{}, lw=lw)}
         \PY{l+s+sd}{plt.fill\PYZus{}between(param\PYZus{}range, test\PYZus{}scores\PYZus{}mean \PYZhy{} test\PYZus{}scores\PYZus{}std,}
         \PY{l+s+sd}{                 test\PYZus{}scores\PYZus{}mean + test\PYZus{}scores\PYZus{}std, alpha=0.2,}
         \PY{l+s+sd}{                 color=\PYZdq{}navy\PYZdq{}, lw=lw)}
         \PY{l+s+sd}{plt.legend(loc=\PYZdq{}best\PYZdq{})}
         \PY{l+s+sd}{plt.show()}
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         \PY{l+s+sd}{import plot\PYZus{}classifiers as pc}
         \PY{l+s+sd}{from sklearn.ensemble import GradientBoostingClassifier}
         \PY{l+s+sd}{names = [\PYZdq{}Gradient Boosting 1 tree\PYZdq{}, \PYZdq{}Gradient Boosting 3 trees\PYZdq{}, \PYZdq{}Gradient Boosting 100 trees\PYZdq{}]}
         
         \PY{l+s+sd}{classifiers = [}
         \PY{l+s+sd}{    GradientBoostingClassifier(n\PYZus{}estimators=1, random\PYZus{}state=0, learning\PYZus{}rate=0.5),}
         \PY{l+s+sd}{    GradientBoostingClassifier(n\PYZus{}estimators=3, random\PYZus{}state=0, learning\PYZus{}rate=0.5),}
         \PY{l+s+sd}{    GradientBoostingClassifier(n\PYZus{}estimators=100, random\PYZus{}state=0, learning\PYZus{}rate=0.5)}
         \PY{l+s+sd}{    ]}
         
         \PY{l+s+sd}{pc.plot\PYZus{}classifiers(names, classifiers, figuresize=(20,8))  }
         \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
\end{Verbatim}
